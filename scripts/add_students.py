...
def create_students():
    ...
    # List of the first 10 students
    students_to_create = [
        {"name": "Rakesh Jana", "username": "rakeshjana", "password": "#rj@123"},
        {"name": "Jakia Jafar", "username": "jakiajafar", "password": "#jj@123"},
        {"name": "Subhajit Kar", "username": "subhajitkar", "password": "#sk@123"},
        {"name": "Arnab Dey", "username": "arnabdey", "password": "#ad@123"},
        {"name": "Sneha Maity", "username": "snehamaity", "password": "#sm@123"},
        {"name": "Jit Roy", "username": "jitroy", "password": "#jr@123"},
        {"name": "Madhusudan Adak", "username": "madhusudanadak", "password": "#ma@123"},
        {"name": "Soumil Kumar Maiti", "username": "soumilkumarmaity", "password": "#skm@123"},
        {"name": "Shiuli Samanta", "username": "shiulisamanta", "password": "#ss@123"},
        {"name": "Surya Nath Kuila", "username": "suryanathkuila", "password": "#snk@123"},
    ]
    ...
    print(f"Done! All {len(students_to_create)} students processed.")
