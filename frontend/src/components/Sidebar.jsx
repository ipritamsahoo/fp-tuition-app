                ...
                <div className="p-6 border-b border-[#1a1f2e]/60">
                    <div className="flex items-center gap-3">
                        <img 
                            src={logoSrc} 
                            alt="FP Finance Logo" 
                            className="w-10 h-10 rounded-xl shadow-lg shadow-[#3861fb]/25 object-cover pointer-events-none select-none" 
                            draggable="false"
                ...
                <div className="flex items-center justify-between px-4 h-14">
                    <div className="flex items-center gap-2.5">
                        <img 
                            src={logoSrc} 
                            alt="FP Finance Logo" 
                            className="w-8 h-8 rounded-lg shadow-lg shadow-[#3861fb]/25 object-cover pointer-events-none select-none" 
                            draggable="false"
                            onDoubleClick={(e) => { e.preventDefault(); e.stopPropagation(); }}
                            onMouseDown={(e) => { if (e.detail > 1) e.preventDefault(); }}
                        />
